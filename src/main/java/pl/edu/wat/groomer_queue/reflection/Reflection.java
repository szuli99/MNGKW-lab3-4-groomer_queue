package pl.edu.wat.groomer_queue.reflection;
...
public class Reflection {
   ...
   private ByteBuddy byteBuddy;
    ...
    public Reflection() {
        ...
        this.entityDefinition = typePool.describe("pl.edu.wat.groomer_queue.entity.Owner").resolve();
        this.requestDefinition = typePool.describe("pl.edu.wat.groomer_queue.dto.OwnerRequest").resolve();
        this.responseDefinition = typePool.describe("pl.edu.wat.groomer_queue.dto.OwnerResponse").resolve();
        this.mapperDefinition = typePool.describe("pl.edu.wat.groomer_queue.mapper.OwnerMapper").resolve();
